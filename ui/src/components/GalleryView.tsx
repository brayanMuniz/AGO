          ...
          if (isSelecting) {
            return (
              <div
                ...
                className={`break-inside-avoid bg-gray-800 rounded overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer relative ${
                  isSelected ? 'ring-4 ring-blue-500' : 'hover:ring-2 hover:ring-pink-500'
                }`}
              >
                {isSelected && (
